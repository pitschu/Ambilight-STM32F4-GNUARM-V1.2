/**
  ...
  * @author    Coocox
  * @version   V1.0		(modified for GCC by pitschu)
  * @date      03/05/2012
...
extern unsigned long _estack;      /*!< End address for the .bss section        */
...
{
  /*----------Core Exceptions------------------------------------------------ */
  (void *)&_estack,     	 /*!< The initial stack pointer (pitschu)         */
...
void Default_Reset_Handler(void)
{
  ...
  // pitschu: application should call SystemInit()
  main();
}
