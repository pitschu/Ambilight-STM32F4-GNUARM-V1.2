...
static void SetSysClock(void)
{
	...
	if (HSEStatus == (uint32_t)0x01)
	{
		...
		FLASH->ACR = FLASH_ACR_ICEN |FLASH_ACR_DCEN |FLASH_ACR_LATENCY_5WS | FLASH_ACR_PRFTEN;  // pitschu: enable prefetch
// pitschu: 		FLASH->ACR = FLASH_ACR_ICEN |FLASH_ACR_DCEN |FLASH_ACR_LATENCY_5WS ; // pitschu:  | FLASH_ACR_PRFTEN;
